...
// ExtendMiningLicense represents the license extension document stored in MongoDB
type ExtendMiningLicense struct {
	...
	ExistingPits          string `json:"existingPits,omitempty" bson:"existingPits,omitempty"` // "yes" | "no"
	...
	ReportsSubmitted      string `json:"reportsSubmitted,omitempty" bson:"reportsSubmitted,omitempty"`
	...
	DirectorApproval         string `json:"directorApproval,omitempty" bson:"directorApproval,omitempty"`
	RecommendationDate       string `json:"recommendationDate,omitempty" bson:"recommendationDate,omitempty"`
	ChairmanApproval         string `json:"chairmanApproval,omitempty" bson:"chairmanApproval,omitempty"`
	ChairmanApprovalDate     string `json:"chairmanApprovalDate,omitempty" bson:"chairmanApprovalDate,omitempty"`
...
// PaginatedExtendMiningLicenses represents a paginated list of license extend applications
type PaginatedExtendMiningLicenses struct {
	Data       []ExtendMiningLicense `json:"data"`
...
// ExtendMiningLicenseRepository defines DB operations for mining license extend applications
type ExtendMiningLicenseRepository interface {
	Create(ctx context.Context, license *ExtendMiningLicense) error
	GetByID(ctx context.Context, id string) (*ExtendMiningLicense, error)
	GetAll(ctx context.Context) ([]ExtendMiningLicense, error)
	GetByTIN(ctx context.Context, tin string, page int, limit int) (*PaginatedExtendMiningLicenses, error)
	GetForMap(ctx context.Context, filters MapFilters) ([]ExtendMiningLicense, error)
...
type ExtendMiningLicenseUsecase interface {
	Submit(ctx context.Context, license *ExtendMiningLicense) (*ExtendMiningLicense, error)
	GetByID(ctx context.Context, id string) (*ExtendMiningLicense, error)
	GetAll(ctx context.Context) ([]ExtendMiningLicense, error)
	GetByTIN(ctx context.Context, tin string, page int, limit int) (*PaginatedExtendMiningLicenses, error)
	GetForMap(ctx context.Context, filters MapFilters) ([]ExtendMiningLicense, error)
	UpdateStatus(ctx context.Context, id string, status string) error
	Edit(ctx context.Context, id string, updatedLicense *ExtendMiningLicense) (*ExtendMiningLicense, error)
}
